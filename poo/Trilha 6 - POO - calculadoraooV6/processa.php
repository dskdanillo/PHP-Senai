...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($val1 === null || $val2 === null) {
        ...
        por intermedio do objeto da classe, vai acessar os métodos da classe 
    ...
    /*Exibe o resultado chamado o método estático exibirResultado()
    que encontra-se na classe estática Clculadora */
